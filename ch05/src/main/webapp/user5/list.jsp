...
<html>
	<head>
		<meta charset="UTF-8">
		<title>user5 테이블 목록</title>
	</head>
	<body>
		<h3>user5 테이블 목록</h3>
		<a href="/ch05/dbcp.jsp">처음으로</a>
		<a href="/ch05/user5/register.jsp">삽입하기</a>
		<table border="1">
			<tr>
				<td>이름</td>
				<td>성별</td>
			...
			<tr>
				...
				<td><%=dto.getAddr() %></td>
				<td>
					<a href="/ch05/user5/modify.jsp?name=<%=dto.getName()%>">수정</a>
					<a href="/ch05/user5/delete.jsp?name=<%=dto.getName()%>">삭제</a>
				</td>
			</tr>
			<%} %>
		</table>
