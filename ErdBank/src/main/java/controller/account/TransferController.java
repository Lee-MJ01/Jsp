...
public class TransferController extends HttpServlet{
	...
	private CustomerService custService = CustomerService.INSTANCE;
	private TransactionService tranService = TransactionService.INSTANCE;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		CustomerDTO sessCustomer = (CustomerDTO) session.getAttribute("sessionCustomer");
		String c_no = sessCustomer.getC_no();
		
		// 사용자 조회
		CustomerDTO customerDTO =  custService.findById(c_no);
