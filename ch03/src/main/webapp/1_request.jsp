...
<html>
	<head>
		...
		<%--
			...
			- 보안에 취약하지만 POST 전송에 비해 빠른 전송이 가능
			
			POST 요청
			- 데이터를 요청 객체 body에 저장해서 전송되는 방식
	...
	<body>
		...
		<a href="./proc/result1.jsp?uid=a102&name=이민준"> 요청2</a>
		...
		<p>
			...
			헤더정보 #2 : <%= request.getHeader("referer") %><br> <!-- 현재 머무르고 있는 페이지 직전의 요청 페이지(뒤로가기를 눌렀을 때 나오는 페이지) -->
