...
<html>
	...
	<body>
		...
		<a href="/ErdCollege/lecture/register.do">목록이동</a>
		...
		<form action="/ErdCollege/lecture/register.do" method="post">
			<table border="1">
				...
				<tr>
					<td>분반</td>
					<td><input type="number" name="lecCredit" placeholder="분반 입력"/></td>
				</tr>
				<tr>
					<td>강의시간</td>
					<td><input type="number" name="lecTime" placeholder="강의시간 입력"/></td>
				</tr>
				<tr>
					<td>강의실</td>
