...
<html>
	<head>
		...
		<!-- 
			...
			로그 설정
			 ...
			 - https://logback.qos.ch/manual/configuration.html 에서 설정 logback.xml 복사
	...
	<body>
		...
		<a href="/ch10/shop/product/list.do">CUSTOMER CRUD</a>
		...
		<h4>Bank</h4>
		<a href="/ch10/bank/account/list.do">CUSTOMER CRUD</a>
		<a href="/ch10/bank/customer/list.do">CUSTOMER CRUD</a>
		
		<h4>library</h4>
		<a href="/ch10/library/member/list.do">CUSTOMER CRUD</a>
